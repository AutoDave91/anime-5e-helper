    ...
    "playableRaces": [
        {
            ...
            'race_mods': [
                ...
                { 'name': 'Unique AJribute (x4 Thrown Weapon Distance)', 'modifier': 2 },
                { 'name': 'Charisma -', 'modifier': -1 },
                { 'name': 'AC Penalty', 'modifier': -4 },
                { 'name': 'Inept AJack (-4 aJack rolls)', 'modifier': -4 },
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'Special Movement (Zen DirecHon)', 'modifier': 1 }
            ]
        },
        {
            "race": 'Blinkbeast',
            ...
            'img': '../assets/',
            'race_mods': [
                { 'name': 'Alternate IdenHty (Human Form)', 'modifier': 1 },
                { 'name': 'Dynamic Powers – Lesser (VegetaHon; Area: 30’ -2; ConcentraHon +1; Unpredictable +1)', 'modifier': 5 },
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'Unique AJribute (x2 Thrown Weapon Distance)', 'modifier': 1 },
                { 'name': 'Wisdom -', 'modifier': -2 },
                { 'name': 'Charisma -', 'modifier': -2 },
                { 'name': 'AC Penalty', 'modifier': -2 },
                { 'name': 'Inept AJack (-2 aJack rolls)', 'modifier': -2 },
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'Combat Mastery (+6 aJack rolls)', 'modifier': 6 },
                { 'name': 'Control Environment (Lights)', 'modifier': 1 },
                { 'name': 'Features (DirecHon Sense, Scentless)', 'modifier': 2 },
                ...
                { 'name': 'Unique AJribute (Small, Light, and Unobtrusive)', 'modifier': 3 },
                ...
                { 'name': 'SuscepHble (+6 Standard damage)', 'modifier': -6 },
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'Features (Ambidexterity, Darkvision 60’, Ultrasonic CommunicaHon)', 'modifier': 3 },
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'Weapon: Fire Breath (2d6 damage; ConHnuing -1; Range: 30’ -2; Spreading: 3 targets -2; Save +4)', 'modifier': 4 }
            ]
        },
        {
            "race": 'Half-Elf',
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'RegeneraHon (4 HP/round)', 'modifier': 4 },
                { 'name': 'ConsHtuHon -', 'modifier': -1 }
            ],
        },
        {
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'CogniHon (PostcogniHon)', 'modifier': 2 },
                { 'name': 'Combat Mastery (+4 aJack rolls)', 'modifier': 4 },
                { 'name': 'Language (Common, Sylvan)', 'modifier': 1 },
                { 'name': 'Spell-Like Ability (Banishment)', 'modifier': 5 },
                { 'name': 'Spell-Like Ability (Cure Wounds)', 'modifier': 2 },
                { 'name': 'Unique AJribute (Small, Light, and Unobtrusive)', 'modifier': 2 },
                ...
                { 'name': 'SuscepHble (+4 Standard damage)', 'modifier': -4 },
        ...
        },
        {
            ...
            'img': '../assets/',
            'race_mods': [
                { 'name': 'ElasHcity (Two limbs stretch 5x; +4 grappling checks)', 'modifier': 4 },
                { 'name': 'Extra AcHons – Lesser (1 Extra AcHon/round; not aJacks)', 'modifier': 2 },
                { 'name': 'Immunity (Lightning)', 'modifier': 6 },
                { 'name': 'Massive Damage – Lesser (+1d8 unarmed aJacks)', 'modifier': 4 },
        ...
        },
        {
            ...
            'race_mods': [
                ...
                { 'name': 'ElasHcity (EnHre body stretches 5x; +10 grappling checks)', 'modifier': 10 },
                { 'name': 'Combat Mastery (+2 aJack rolls)', 'modifier': 2 },
                { 'name': 'Language (Common, Undercommon)', 'modifier': 1 },
                { 'name': 'RegeneraHon (2 HP/round)', 'modifier': 2 },
                { 'name': 'Special Movement (Slithering)', 'modifier': 1 },
                { 'name': 'Unique AJribute (Small, Light, and Unobtrusive)', 'modifier': 1 },
                ...
                { 'name': 'SuscepHble (+2 Standard damage)', 'modifier': -2 },
